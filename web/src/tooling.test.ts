  ...
  it("builds update payloads without empty secret fields", () => {
    expect(
      buildSettingsPayload({
        ...
        torboxRequestsPerMinute: "180",
        resolverNegativeCacheSeconds: "20",
        resolverCircuitBreakerFailures: "4",
        resolverCircuitBreakerWindowSeconds: "90",
        resolverCircuitBreakerCooldownSeconds: "45",
        torboxApiKey: "",
        tmdbApiKey: "tmdb",
        resolverToken: "",
